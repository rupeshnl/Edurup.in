...
export async function POST(req: Request) {
  try {
    ...
    const subject = `New Live Demo Lead from ${fullName}`;
    const body = `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f0f4f8; color: #333;">
    <h2 style="color: #333; border-bottom: 2px solid #6ed290; padding-bottom: 10px;">Live Demo Lead</h2>
