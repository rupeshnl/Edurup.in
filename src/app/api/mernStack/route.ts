...
export async function POST(req: Request) {
  try {
    const { fullName, email, phoneNumber, highestQualification, nativeState } =
      await req.json();
