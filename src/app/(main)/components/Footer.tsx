            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-lg">
                  Join 50,000+ learners who get exclusive access to new courses,
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Transforming careers through world-class education. Learn from
                industry experts and advance your skills with our comprehensive
                courses.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              <div className="text-center p-4 rounded-lg bg-muted/20">
                <div className="text-2xl font-bold text-fg">50K+</div>
            ...
            <div className="space-y-3 text-left">
              ...
              >
                ...
                <span>
                  Salarpuria Touch Stone, Kadbuseenahalli, Bangalore - 560103
                </span>
              </Link>
              <Link
                href="tel:+919849036024"
                className="flex items-center gap-3 text-muted-foreground hover:text-fg transition"
              >
                <Phone className="h-5 w-5 text-fg" />
                <span>+91 98490 36024</span>
              </Link>
              <Link
        ...
        <div className="mt-12 pt-8 border-t border-muted/20 flex flex-col lg:flex-row justify-between items-center gap-8">
          <div>
            ...
            <div className="flex gap-4">
              {socialLinks.map(({ href, icon: Icon, followers }) => (
        ...
        <div className="flex flex-wrap gap-2">
          {legal.map((item, i) => (
            <span key={item.href} className="flex items-center gap-2">
              ...
              {i < legal.length - 1 && <span className="text-muted/50">|</span>}
            </span>
          ))}
        </div>
        <div className="flex items-center gap-2">
