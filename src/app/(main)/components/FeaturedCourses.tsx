...
const FeaturedCourses = () => {
  const softwareCourses = [
...

    {
      ...
      description:
        "Become a job-ready Data Analytics professional in 12 weeks. Join the largest tech community in India. Get 1 year Placement Support",
      duration: "3 Months",
      graduation: "Job seekers",
      classes: "Online Live classes",
      job: "100% Job Assurance",
    },
  ];
  const businessCourses = [
    {
      ...
      description:
        "Become a job-ready Digital Marketing Professional in 12 weeks. Join the largest Marketing community in India. Get 1  year Placement Support",
      duration: "3 Months",
      graduation: "Job seekers",
      classes: "Online Live classes",
      job: "100% Job Assurance",
    },
    {
      ...
      description:
        "Become a job-ready Performance Marketing Professional in 12 weeks. Join the largest Marketing community in India. Get 1  year Placement Support ",
      duration: "3 Months",
      graduation: "Job seekers",
      classes: "Online Live classes",
      job: "100% Job Assurance",
