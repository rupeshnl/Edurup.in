        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span>
                New Course Alert: Advanced AI & Machine Learning - Enroll Now!
              </span>
            </div>
            <Button
              size="sm"
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Discover the latest trends, insights, and expert advice in
        ...
        <div className="container mx-auto px-6">
          <div className="mb-12">
            <div className="flex items-center justify-between mb-8">
              ...
              <Badge className="bg-fg text-primary">Editor&apos;s Pick</Badge>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <Button size="sm" className="bg-fg text-primary">
                  1
                </Button>
                <Button variant="outline" size="sm">
                  2
