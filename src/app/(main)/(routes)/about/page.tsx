        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-foreground/90 mb-8 leading-relaxed">
              At Edurup, we believe that quality education should be accessible
              to everyone. We&apos;re on a mission to bridge the skills gap and
              create opportunities for learners worldwide.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-foreground">
                ...
                <span className="text-fg"> Digital Education</span>
              </h2>
              <div className="space-y-6 text-muted-foreground leading-relaxed">
                <p className="text-lg">
                  Founded in 2020 by a team of passionate educators and industry
                  experts, Edurup emerged from a simple yet powerful vision: to
                  make high-quality, practical education accessible to learners
                  everywhere.
                </p>
                <p>
                  We recognized that traditional education often falls short of
                  preparing students for the rapidly evolving digital landscape.
                  That&apos;s why we created a platform that bridges the gap
                  between academic learning and industry requirements.
                </p>
                <p>
                  Today, we&apos;re proud to have helped thousands of students
                  transform their careers, with many securing positions at top
                  companies worldwide. Our success is measured not just in
                  numbers, but in the real impact we make on people&apos;s
                  lives.
                </p>
              </div>
              <div className="mt-8">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-foreground/90 max-w-3xl mx-auto leading-relaxed">
              ...
              learners worldwide. Our commitment to quality education sets us
              apart.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our core values shape everything we do, from course development to
              student support.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-foreground/90 max-w-3xl mx-auto">
              We&apos;ve designed a proven 4-step process that takes you from
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of successful graduates who have advanced their
              careers with Edurup. Your journey to success starts here.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
