                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl md:text-2xl text-foreground/90 mb-8 leading-relaxed">
                            Fill out the form below or schedule a meeting with
                            us at your convenience. We're here to help you
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    ...
                                    our courses? We'd love to hear from you.
                                </p>
                            </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-foreground/90 max-w-3xl mx-auto">
                            We have offices in multiple locations to serve you
                            better. Drop by for a coffee and a chat!
                        </p>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <Card className="hover:shadow-lg transition-shadow">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        Yes! We offer free 30-minute
                                        consultation calls to discuss your
                                        learning goals and recommend the best
                                        courses for you.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="hover:shadow-lg transition-shadow">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        ...
                                        career guidance, mentorship, and job
                                        placement assistance for all our
                                        students.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="hover:shadow-lg transition-shadow">
                                <CardContent className="p-6">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        We welcome visitors to our offices.
